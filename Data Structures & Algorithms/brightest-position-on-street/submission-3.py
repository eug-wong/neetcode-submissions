class Solution:
    def brightestPosition(self, lights: List[List[int]]) -> int:
        ...
        # sweep line
        # end points of interval indicates "change before + after"
        # if we sweep a line over the interval, we can keep track of the current brightness
        # then just keep track of best so far and return
